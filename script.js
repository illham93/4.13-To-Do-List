...
var ToDoList = function (_React$Component2) {
    ...
    _createClass(ToDoList, [{
        ...
        value: function fetchTasks() {
            ...
            fetch("https://fewd-todolist-api.onrender.com/tasks?api_key=1158").then(checkStatus).then(json).then(function (response) {
        ...
        value: function deleteTask(id) {
            ...
            fetch("https://fewd-todolist-api.onrender.com/tasks/" + id + "?api_key=1158", {
                method: "DELETE",
                mode: "cors"
        ...
        value: function toggleComplete(id, completed) {
            ...
            fetch("https://fewd-todolist-api.onrender.com/tasks/" + id + "/mark_" + newState + "?api_key=1158", {
                method: "PUT",
                mode: "cors"
            }).then(checkStatus).then(json).then(function (data) {
                _this5.fetchTasks();
        ...
        value: function handleSubmit(event) {
            ...
            fetch("https://fewd-todolist-api.onrender.com/tasks?api_key=1158", {
                method: "POST",
                mode: "cors",
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "label",
                                null,
                                React.createElement("input", { className: "mx-1", type: "checkbox", name: "all", checked: filter === "all", onChange: this.toggleFilter }),
                                " All"
                            ),
                            React.createElement(
                                "label",
                                null,
                                React.createElement("input", { className: "mx-1", type: "checkbox", name: "active", checked: filter === "active", onChange: this.toggleFilter }),
                                " Active"
                            ),
                            React.createElement(
                                "label",
                                null,
                                React.createElement("input", { className: "mx-1", type: "checkbox", name: "completed", checked: filter === "completed", onChange: this.toggleFilter }),
                                " Completed"
                            )
                        ),
                        React.createElement(
